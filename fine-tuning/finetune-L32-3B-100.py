...
my_dataset = "siacus/climate-finetuning-L3-100"

# Fine-tuned model
new_model = "Llama-32-3B-100-climate-fasrc"
local_model = "local/Llama-32-3B-100-climate-fasrc"

dataset = load_dataset(my_dataset, split={'train': 'train'})
...
wandb.init(
    project="climate",
    reinit=True,
    name="llama-32-3b-100-climate-fasrc",
    config={
