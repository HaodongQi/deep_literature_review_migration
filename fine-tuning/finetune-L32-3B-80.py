...
my_dataset = "siacus/climate-finetuning-L3-80"

# Fine-tuned model
new_model = "Llama-32-3B-80-climate-fasrc"
local_model = "local/Llama-32-3B-80-climate-fasrc"
...
wandb.init(
    project="climate",
    reinit=True,
    name="llama-32-3b-80-climate-fasrc",
    config={
