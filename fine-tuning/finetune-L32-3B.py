...
my_dataset = "siacus/climate-finetuning-L3"

# Fine-tuned model
new_model = "Llama-32-3B-climate-fasrc"
local_model = "local/Llama-32-3B-climate-fasrc"
...
wandb.init(
    project="climate",
    reinit=True,
    name="llama-32-3b-climate-fasrc",
    config={
...
training_params = SFTConfig(
    ...
    optim=optimizer,
    weight_decay=0.001,
    save_steps=250,  # Save checkpoint every 250 steps (adjust as needed)
    logging_steps=50,
    fp16=False,
